...
namespace Root_Consume.Services
{
    /// <summary>
    /// 从broker消费消息
    /// 测试Direct消息模型，一个消费成功，一个消费失败最后消失状态
    /// </summary>
    public class MsgFailSuccessTestServerA : IHostedService, IDisposable
    {
        private readonly ILogger _logger;
        private readonly IConnection _rabbitConnection;
        private readonly IModel _channel;
        public MsgFailSuccessTestServerA(ILogger<MsgFailSuccessTestServerA> logger, IConnection rabbitConnection)
        {
            _logger = logger;
